...
namespace AIOSEO\Plugin\Addon\Redirects {
	...
	final class Redirects {
		...
		public function load() {
			require_once( AIOSEO_REDIRECTION_MANAGER_DIR . '/extend/updates.php' );
			new \AIOSEOUpdates( 'aioseo-redirects', $this->version, plugin_basename( AIOSEO_REDIRECTION_MANAGER_FILE ) );
